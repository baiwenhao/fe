  ...
  <div class="in-test">
    <div class="card-box" v-for="(items, index) in cardBox" :key="index">
      ...
      <el-card shadow="hover" class="box-card">
        ...
        <div class="footer">
          <!-- <el-button @click="handlePublish(items)">Publish</el-button> -->
          <el-button @click="handleToCreate('view', items.configId, '4')"
            >View</el-button
          >
          <el-button @click="handleClose(items)" v-if="checkApproval === 'approve' || checkApproval === 'admin'">Close</el-button>
