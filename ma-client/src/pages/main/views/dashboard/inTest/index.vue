  ...
  <div class="in-test" v-loading="loading">
    <div class="card-box" v-for="(items, index) in cardBox" :key="index">
      ...
      <el-card shadow="hover" class="box-card">
        ...
        <div class="footer">
          <!-- <el-button @click="handleToCreate('edit', items.configId, '7')"
            >Edit</el-button
          > -->
          <el-button @click="handleToCreate('view', items.configId, '7')" v-if="checkApproval !== 'approve'"
            >View</el-button
          >
          <el-button @click="handleDownload(items)" v-if="checkApproval !== 'approve'">Download</el-button>
          <el-button @click="handleComplete(items)" v-if="checkApproval !== 'approve'">Complete Test</el-button>
    ...
    <complete-test-list
      @activeNameInTest="activeNameInTest"
      :configId="configId"
      :appId="appId"
...
export default {
  ...
  components: {
    "complete-test-list": () => import("./completeTestList.vue")
  },
  computed: {
    noData() {
